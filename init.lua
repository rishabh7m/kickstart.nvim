...
-- [rishabh7m]
-- Block cursor with blinking in all modes
vim.o.guicursor = "a:block-blinkwait300-blinkon200-blinkoff150"
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- VSCode-like fuzzy finders ([f]ind group)
      vim.keymap.set('n', '<leader>ff', builtin.find_files, { desc = '[F]ind [F]iles' })
      vim.keymap.set('n', '<leader>fg', builtin.live_grep, { desc = '[F]ind by [G]rep (all files)' })
